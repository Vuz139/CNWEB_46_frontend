...
const NewOrder = () => {
  ...
  const handleDistrictChange = (e) => {
    ...
    const communes =
      districts[districts.findIndex((value) => value.n === e.target.value)];
  ...
  const handleCommuneChange = (e) => {
    setShippingInfo((prev) => ({
      ...
      postalCode: communes[communes.findIndex((c) => c.n === e.target.value)].i,
    }));
  };
      ...
      <form class="information-container">
        <div class="checkout__form">
          ...
          <div class="address-form">
            ...
            <select value={shippingInfo.commune} onChange={handleCommuneChange}>
      ...
      <div class="product-container">
        ...
        {cart.map((prod) => (
          <div className="product-info">
            ...
            <strong className="checkout__product__price">{prod.price}</strong>
          </div>
        ))}
